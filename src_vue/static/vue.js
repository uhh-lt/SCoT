const app = new Vue({
  ...
  data: {
    ...
    graph_type_keys: {
      "n & d per INTERVAL (best for overview and time-diff)": "ngot_interval",
  ...
  methods: {
    ...
    calculateCentralityDistribution: function () {
      ...
      app.centrality_score_distribution.push(
        { centrality_score: "x < " + app.gr0_ul, number_of_nodes: group0 },
        {
        ...
        { centrality_score: "x > " + app.gr3_ul, number_of_nodes: group4 }
      );
    },
    /*
    ...
    getCentralityScores: function () {
      ...
      for (let d of app.nodes) {
        if (d["centrality_score"] != null) {
          app.centrality_scores.push(parseFloat(d["centrality_score"]));
        }
      }
    ...
    saveGraph: function () {
      ...
      if (app.updated_nodes === null && app.updated_links === null) {
        a.download =
          app.target_word + "_" + app.senses + "_" + app.edges + ".json";
      } else {
        a.download =
          app.target_word +
          "_" +
