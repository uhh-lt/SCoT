...
"""  
TODO NEEDS IMPROVEMENT FOR D3-FORMAT (IN USE CURRENTLY)
TODO Renaming of elements to NGOT
This defines the model of the clustered neighbourhood graph over time
Which is build from the raw-edges of the orm-model and sent to the frontend
(it is also send back for the reclustering)
"""
